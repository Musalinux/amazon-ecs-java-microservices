...
def create_ecs_cluster(stack_name):
    ...
    ami_id = describe_images_response['Images'][0]['ImageId']
    ...
    try:
        response = cf_client.create_stack(
            ...
            Parameters=[
                {'ParameterKey': 'AsgMaxSize', 'ParameterValue': '2', 'UsePreviousValue': True},
                {'ParameterKey': 'EcsAmiId', 'ParameterValue': ami_id, 'UsePreviousValue': True},
                {'ParameterKey': 'EcsClusterName', 'ParameterValue': stack_name, 'UsePreviousValue': True},
                {'ParameterKey': 'KeyName', 'ParameterValue': stack_name + 'key', 'UsePreviousValue': True},
                {'ParameterKey': 'EcsInstanceType', 'ParameterValue': 'm4.large', 'UsePreviousValue': True},
                {'ParameterKey': 'DBUsername', 'ParameterValue': 'PetClinicDB'},
                {'ParameterKey': 'DBPassword', 'ParameterValue': 'PetClinicPassw0rd'}
            ],
